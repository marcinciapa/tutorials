package com.github.marcinciapa.server.service.implementation;

import com.github.marcinciapa.server.model.Server;
import com.github.marcinciapa.server.repo.ServerRepo;
import com.github.marcinciapa.server.service.ServerService;
...
public class ServerServiceImpl implements ServerService {
    ...
    public Server update(Server server) {
        ...
        return serverRepo.save(server); // JPA knows it's an existing ID, so doesn't create, but updates
    ...
    private String setServerImageUrl() {
        ...
        // For Random.nextInt, boundary is exclusive
