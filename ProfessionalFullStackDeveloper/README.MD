...
- Surefire Maven plugin is use during the 'test' phase to execute the unit tests and generate reports.
...
- Spring Boot Maven offers a lot of good features: processing AOT, generating OCI images etc.
